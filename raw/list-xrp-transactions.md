# List transactions
GET https://api.iofinnet.com/v1/transactions/ecosystem/xrp/chain/{chain}/address/{address}

Retrieves a paginated list of transactions associated with a specific address on xrp ecosystem
