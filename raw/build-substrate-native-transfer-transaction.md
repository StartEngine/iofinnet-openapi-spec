...
POST https://api.iofinnet.com/v1/vaults/{vaultId}/transactions/ecosystem/substrate/chain/bittensor/build-native-transaction

Builds a transaction hex for a native transfer on the Bittensor chain.
